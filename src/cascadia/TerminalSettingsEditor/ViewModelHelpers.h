...
protected:
    ...
    {
        _propertyChangedHandlers(*static_cast<T*>(this), ::winrt::Microsoft::UI::Xaml::Data::PropertyChangedEventArgs{ name });
    }
...
private:
    winrt::event<::winrt::Microsoft::UI::Xaml::Data::PropertyChangedEventHandler> _propertyChangedHandlers;
};
