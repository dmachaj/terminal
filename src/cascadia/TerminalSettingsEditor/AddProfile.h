...
namespace winrt::Microsoft::Terminal::Settings::Editor::implementation
{
    ...
    public:
        ...
        void AddNewClick(const IInspectable& sender, const Microsoft::UI::Xaml::RoutedEventArgs& eventArgs);
        void DuplicateClick(const IInspectable& sender, const Microsoft::UI::Xaml::RoutedEventArgs& eventArgs);
        void ProfilesSelectionChanged(const IInspectable& sender, const Microsoft::UI::Xaml::RoutedEventArgs& eventArgs);
