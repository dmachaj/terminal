...
namespace winrt::Microsoft::Terminal::Settings::Editor::implementation
{
    struct Converters : ConvertersT<Converters>
    {
        ...
        static winrt::Microsoft::UI::Xaml::Media::SolidColorBrush ColorToBrush(winrt::Windows::UI::Color color);
        static double FontWeightToDouble(winrt::Windows::UI::Text::FontWeight fontWeight);
        static bool InvertBoolean(bool value);
        static winrt::Microsoft::UI::Xaml::Visibility InvertedBooleanToVisibility(bool value);
        ...
        static winrt::Microsoft::UI::Xaml::Visibility StringNotEmptyToVisibility(winrt::hstring value);
